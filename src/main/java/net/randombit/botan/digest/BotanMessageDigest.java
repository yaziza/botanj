 ...
 *
 * <p>This class provides a JCE-compliant MessageDigest implementation that delegates hash
 * computations to native Botan library functions via JNR-FFI. It implements automatic native
 * resource management using the Java {@link Cleaner} API to ensure native hash objects are properly
 * destroyed when no longer needed.
 *
 * <h2>Lifecycle and Resource Management</h2>
 *
 * <p>Native Botan hash objects are created during construction and destroyed automatically by the
 * Cleaner when the Java object becomes unreachable (garbage collection). Unlike MAC and Cipher
 * implementations, MessageDigest objects are not re-initializable - once created, they maintain the
 * same hash algorithm for their entire lifetime.
 *
 * <h2>Thread Safety</h2>
 *
 ...
 * native hash state is copied using Botan's {@code botan_hash_copy_state} function, allowing
 * independent computation of digests from the same intermediate state. Each cloned instance
 * maintains its own native resource that is independently managed by the Cleaner.
 *
 ...
 *
 * <ul>
 *   <li><b>SHA-1</b> - {@link SHA1} - SHA-1 (20-byte output) - <i>Not recommended for
 *       security-critical applications</i>
 *   <li><b>SHA-224</b> - {@link SHA224} - SHA-2 family (28-byte output)
 *   <li><b>SHA-256</b> - {@link SHA256} - SHA-2 family (32-byte output)
 *   <li><b>SHA-384</b> - {@link SHA384} - SHA-2 family (48-byte output)
 *   <li><b>SHA-512</b> - {@link SHA512} - SHA-2 family (64-byte output)
 *   <li><b>SHA-3(224)</b> - {@link SHA3_224} - SHA-3 family (28-byte output)
 *   <li><b>SHA-3(256)</b> - {@link SHA3_256} - SHA-3 family (32-byte output)
 *   <li><b>SHA-3(384)</b> - {@link SHA3_384} - SHA-3 family (48-byte output)
 *   <li><b>SHA-3(512)</b> - {@link SHA3_512} - SHA-3 family (64-byte output)
 *   <li><b>Keccak-1600(224)</b> - {@link Keccak224} - Keccak (28-byte output)
 *   <li><b>Keccak-1600(256)</b> - {@link Keccak256} - Keccak (32-byte output)
 *   <li><b>Keccak-1600(384)</b> - {@link Keccak384} - Keccak (48-byte output)
 *   <li><b>Keccak-1600(512)</b> - {@link Keccak512} - Keccak (64-byte output)
 *   <li><b>Blake2b(160)</b> - {@link Blake2b160} - BLAKE2b (20-byte output)
 *   <li><b>Blake2b(256)</b> - {@link Blake2b256} - BLAKE2b (32-byte output)
 *   <li><b>Blake2b(384)</b> - {@link Blake2b384} - BLAKE2b (48-byte output)
 *   <li><b>Blake2b(512)</b> - {@link Blake2b512} - BLAKE2b (64-byte output)
 *   <li><b>MD4</b> - {@link MD4} - MD4 (16-byte output) - <i>Not recommended for security-critical
 *       applications</i>
 *   <li><b>MD5</b> - {@link MD5} - MD5 (16-byte output) - <i>Not recommended for security-critical
 *       applications</i>
 *   <li><b>RIPEMD-160</b> - {@link RipeMd160} - RIPEMD-160 (20-byte output)
 * </ul>
 *
 * <h2>Implementation Notes</h2>
 *
 * <ul>
 *   <li><b>Cloning Supported</b> - Unlike MAC and Cipher, MessageDigest supports cloning via native
 *       state copy
