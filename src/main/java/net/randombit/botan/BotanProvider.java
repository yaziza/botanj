...
/**
 * Java Security Provider implementation that provides cryptographic algorithms using the Botan
 * native library.
 *
 * <p>This provider integrates the Botan cryptography library into the Java Cryptography
 * Architecture (JCA), making Botan's high-performance native implementations available through
 * standard JCA APIs. All cryptographic operations are delegated to the native Botan library via
 * JNR-FFI.
 *
 * <h2>Installation and Usage</h2>
 *
 * <p>The provider can be registered statically in the security properties file or dynamically at
 * runtime:
 *
 ...
 *
 * <ul>
 *   <li><b>MD Family:</b> MD4, MD5 (deprecated for security)
 *   <li><b>SHA-1:</b> SHA-1 (deprecated for security)
 *   <li><b>SHA-2 Family:</b> SHA-224, SHA-256, SHA-384, SHA-512
 *   <li><b>SHA-3 Family:</b> SHA3-224, SHA3-256, SHA3-384, SHA3-512
 *   <li><b>Keccak:</b> KECCAK-224, KECCAK-256, KECCAK-384, KECCAK-512
 *   <li><b>BLAKE2b:</b> BLAKE2B-160, BLAKE2B-256, BLAKE2B-384, BLAKE2B-512
 *   <li><b>RIPEMD:</b> RIPEMD-160
 * </ul>
 *
 * <h3>Message Authentication Codes (MACs)</h3>
 *
 * <ul>
 *   <li><b>HMAC-SHA2:</b> HMAC-SHA1, HMAC-SHA224, HMAC-SHA256, HMAC-SHA384, HMAC-SHA512
 *   <li><b>HMAC-SHA3:</b> HMAC-SHA3-224, HMAC-SHA3-256, HMAC-SHA3-384, HMAC-SHA3-512
 *   <li><b>HMAC-Other:</b> HMAC-MD5, HMAC-RIPEMD160
 *   <li><b>CMAC:</b> CMAC (AES-based cipher MAC)
 *   <li><b>Poly1305:</b> Poly1305
 *   <li><b>SipHash:</b> SipHash (SipHash-2-4)
 * </ul>
 *
 * <h3>Symmetric Ciphers</h3>
 *
 * <p><b>AES (Advanced Encryption Standard):</b>
 *
 * <ul>
 *   <li>Block modes: AES/CBC, AES/CFB
 *   <li>Stream modes: AES/CTR/NoPadding, AES/OFB/NoPadding
 *   <li>AEAD modes: AES/GCM, AES/CCM, AES/SIV, AES/EAX, AES/OCB
 * </ul>
 *
 * <p><b>DES (Data Encryption Standard):</b>
 *
 * <ul>
 *   <li>Block modes: DES/CBC, DES/CFB
 *   <li>Stream modes: DES/CTR/NoPadding, DES/OFB/NoPadding
 * </ul>
 *
 * <p><b>Triple DES (3DES/DESede):</b>
 *
 * <ul>
 *   <li>Block modes: DESede/CBC, DESede/CFB (also aliased as 3DES and TripleDES)
 *   <li>Stream modes: DESede/CTR/NoPadding, DESede/OFB/NoPadding
 * </ul>
 *
 * <p><b>Stream Ciphers:</b>
 *
 * <ul>
 *   <li>Salsa20/None/NoPadding, XSalsa20/None/NoPadding
 *   <li>ChaCha20/None/NoPadding, XChaCha20/None/NoPadding
 * </ul>
 *
 * <h3>Random Number Generators</h3>
 *
 * <ul>
 *   <li><b>BotanSystem (System RNG):</b> OS-provided entropy source (default, thread-safe)
 *   <li><b>BotanUser:</b> User-space ChaCha20-based CSPRNG (fast, not thread-safe)
 *   <li><b>BotanUserThreadsafe:</b> Thread-safe user-space CSPRNG
 * </ul>
 *
 * <h2>Padding Schemes for Block Ciphers</h2>
 *
 * <p>Block cipher modes (CBC, CFB) support the following padding schemes:
 *
 * <ul>
 *   <li><b>PKCS7</b> - PKCS#7 padding (most common, recommended)
 *   <li><b>PKCS5</b> - PKCS#5 padding (equivalent to PKCS7 for 8-byte blocks)
 *   <li><b>X9.23</b> - ANSI X9.23 padding
 *   <li><b>OneAndZeros</b> - ISO/IEC 7816-4 padding
 *   <li><b>ESP</b> - ESP padding (RFC 4303)
 *   <li><b>NoPadding</b> - No padding (plaintext must be multiple of block size)
 * </ul>
 *
 * <p>Example: {@code Cipher.getInstance("AES/CBC/PKCS7", "Botan")}
 *
 * <h2>Algorithm Aliases</h2>
 *
 * <p>This provider supports multiple aliases for convenience and compatibility:
 *
 * <ul>
 *   <li><b>SHA-256</b> can also be accessed as "SHA256"
 *   <li><b>HmacSHA256</b> is an alias for "HMAC-SHA256"
 *   <li><b>AESCMAC</b> is an alias for "CMAC"
 *   <li><b>3DES/CBC</b> and <b>TripleDES/CBC</b> are aliases for "DESede/CBC"
 *   <li>OID aliases are supported for standard algorithms (e.g., "2.16.840.1.101.3.4.2.1" for
 *       SHA-256)
 * </ul>
 *
 ...
 *
 * <p>Provider name: {@value #NAME}
 *
 * <p>Provider info: {@value #INFO}
 *
 * <p>Version: Determined by the native Botan library version (accessible via {@link
 * #getVersionStr()})
 *
 * <h2>Native Library Requirements</h2>
 *
 * <p>This provider requires the Botan 3.x native library to be installed and accessible:
 *
 * <ul>
 *   <li><b>Library name:</b> botan-3 (libbotan-3.so on Linux, libbotan-3.dylib on macOS,
 *       botan-3.dll on Windows)
 *   <li><b>Minimum version:</b> Botan 3.0.0
 *   <li><b>Installation:</b> Via system package manager or built from source
 *   <li><b>Path configuration:</b> Library must be in system library path or specified via
 *       java.library.path
 * </ul>
 *
 * <p>If the native library cannot be loaded, the provider will throw an exception during
 * construction.
 *
 * <h2>Compatibility</h2>
 *
 * <p>This provider is designed to be compatible with other JCE providers:
 *
 * <ul>
 *   <li>Can be used alongside SunJCE, BouncyCastle, and other providers
 *   <li>Follows standard JCA naming conventions and APIs
 *   <li>Supports OID-based algorithm requests for interoperability
 *   <li>Algorithm implementations produce compatible outputs with standard implementations
 * </ul>
 *
 * <h2>Implementation Notes</h2>
 *
 * <ul>
 *   <li><b>Performance:</b> Algorithms delegate to native Botan library for optimal performance
 *   <li><b>Resource Management:</b> Uses Java Cleaner API for automatic native resource cleanup
 *   <li><b>Thread Safety:</b> The provider itself is thread-safe, but individual cipher/digest
 *       instances are not
 *   <li><b>Immutability:</b> The provider is final and cannot be extended
 *   <li><b>Initialization:</b> Provider checks native library availability during construction
 * </ul>
 *
 * @author Yasser Aziza
...
public final class BotanProvider extends Provider {
  ...
  /**
   * The name of this security provider ("Botan"). Used when requesting cryptographic services from
   * this provider.
   */
  ...
  private void addRngAlgorithm() {
    ...
    put(
        "SecureRandom.BotanUserThreadsafe",
        PACKAGE_NAME + RNG_PREFIX + "BotanSecureRandom$UserThreadsafeRng");
  ...
  private void addBlake2Algorithm() {
    put(
        ...
        PACKAGE_NAME + DIGEST_PREFIX + "BotanMessageDigest$Blake2b160");
    ...
    put(
        ...
        PACKAGE_NAME + DIGEST_PREFIX + "BotanMessageDigest$Blake2b256");
    ...
    put(
        ...
        PACKAGE_NAME + DIGEST_PREFIX + "BotanMessageDigest$Blake2b384");
    ...
    put(
        ...
        PACKAGE_NAME + DIGEST_PREFIX + "BotanMessageDigest$Blake2b512");
  ...
  private void addAesAlgorithm() {
    ...
    put(
        ...
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$AesOfb");

    put(
        "Cipher.AES/CTR/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$AesCtr");
  ...
  private void addDesAlgorithm() {
    ...
    put(
        "Cipher.DES/OFB/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$DesOfb");

    put(
        "Cipher.DES/CTR/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$DesCtr");
  }
  ...
  private void addTrippleDesAlgorithm() {
    ...
    put(
        ...
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$DesEdeOfb");
    put("Cipher.3DES/OFB/NoPadding", "DESede/OFB/NoPadding");
    put("Cipher.TripleDES/OFB/NoPadding", "TripleDES/OFB/NoPadding");

    put(
        "Cipher.DESede/CTR/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$DesEdeCtr");
  ...
  private void addSalsa20Algorithm() {
    put(
        "Cipher.Salsa20/None/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$Salsa20");
    put(
        "Cipher.XSalsa20/None/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$XSalsa20");
  }

  private void addChaCha20Algorithm() {
    put(
        "Cipher.ChaCha20/None/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$ChaCha20");
    put(
        "Cipher.XChaCha20/None/NoPadding",
        PACKAGE_NAME + STREAM_CIPHER_PREFIX + "BotanStreamCipher$XChaCha20");

    put(
        "Cipher.ChaCha20/Poly1305",
        PACKAGE_NAME + AEAD_CIPHER_PREFIX + "BotanAeadCipher$ChaCha20Poly1305");
    put("Alg.Alias.Cipher.ChaCha20Poly1305", "ChaCha20/Poly1305");
    put("Alg.Alias.Cipher.ChaCha20-Poly1305", "ChaCha20/Poly1305");

    put(
        "Cipher.XChaCha20/Poly1305",
        PACKAGE_NAME + AEAD_CIPHER_PREFIX + "BotanAeadCipher$XChaCha20Poly1305");
