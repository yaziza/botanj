 ...
 *
 * <p>Wycheproof is a project to test crypto libraries against known attacks. These tests use the
 * official Wycheproof test vectors from: https://github.com/C2SP/wycheproof
 */
public abstract class WycheproofTestBase {
   ...
   */
  protected void logSummaryAndCheckFailures(
      int passed, int failed, int skipped, int numberOfTests, String algorithm) {
    LOG.info(
        "Results: {} passed, {} failed, {} skipped out of {}",
        passed,
        failed,
        skipped,
        numberOfTests);
