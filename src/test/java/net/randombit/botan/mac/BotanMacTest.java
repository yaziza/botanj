...
public class BotanMacTest {
  ...
  public void testMacOutputSize(String algorithm, int keySize, int outputSize)
    ...
    assertEquals(
        outputSize, mac.getMacLength(), "Output size mismatch for algorithm: " + algorithm);
  ...
  public void testMacUpdateWithoutInitialization(String algorithm) throws GeneralSecurityException {
    ...
    final Exception exception =
        assertThrows(IllegalStateException.class, () -> mac.update(new byte[128]));
  ...
  public void testMacDoFinalWithoutInitialization(String algorithm)
      throws GeneralSecurityException {
  ...
  public void testAgainstBouncyCastle(String algorithm, int keySize)
      throws GeneralSecurityException {
  ...
  public void testInvalidKeyModulo() throws Exception {
    ...
    assertTrue(
        exception.getMessage().contains("key.getEncoded()"),
