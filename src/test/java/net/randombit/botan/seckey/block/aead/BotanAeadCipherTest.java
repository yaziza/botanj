...
public class BotanAeadCipherTest {
  ...
  @CsvFileSource(
      resources = {
        "/seckey/block/aead/ccm_no_padding.csv",
        "/seckey/block/aead/eax_no_padding.csv",
        "/seckey/block/aead/gcm_no_padding.csv",
        "/seckey/block/aead/ocb_no_padding.csv",
        "/seckey/block/aead/siv_no_padding.csv",
        "/seckey/block/aead/chacha20poly1305_no_padding.csv",
        "/seckey/block/aead/xchacha20poly1305_no_padding.csv"
      },
      numLinesToSkip = 1)
  ...
  public void testEncryptThenDecrypt(String algorithm, String key, String nonce, String ad)
      throws GeneralSecurityException {
  ...
  public void testCipherWithTestVectors(
      String algorithm, String key, String nonce, String ad, String in, String out)
      throws GeneralSecurityException {
