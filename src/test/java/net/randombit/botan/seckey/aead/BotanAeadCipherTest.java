...
public class BotanAeadCipherTest {
  ...
  @CsvFileSource(
      resources = {
        "/seckey/aead/ccm_no_padding.csv",
        "/seckey/aead/eax_no_padding.csv",
        "/seckey/aead/gcm_no_padding.csv",
        "/seckey/aead/ocb_no_padding.csv"
      },
      numLinesToSkip = 1)
  ...
  public void testCipherBlockSize(String algorithm, String key) throws GeneralSecurityException {
    ...
    assertEquals(
        16, cipher.getBlockSize(), "Cipher block size mismatch for algorithm: " + algorithm);
